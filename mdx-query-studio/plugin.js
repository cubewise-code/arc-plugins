...
arc.run(['$rootScope', function($rootScope) {
    ...
    $rootScope.plugin("cubewiseMdxQueryStudio", "MDX Query Studio", "page", {
        menu: "tools",
        icon: "fa-table",
...
arc.directive("cubewiseMdxQueryStudio", function () {
    return {
        restrict: "EA",
        replace: true,
        scope: {
        ...
        templateUrl: "__/plugins/mdx-query-studio/template.html",
        ...
        controller: ["$scope", "$rootScope", "$http", "$tm1", "$translate", "$timeout", function ($scope, $rootScope, $http, $tm1, $translate, $timeout) {        
            ...
            $scope.$on("close-tab", function(event, args) {
                ...
                if(args.page == "cubewiseMdxQueryStudio" && args.instance == $scope.instance && args.name == null){
