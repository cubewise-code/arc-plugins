...
arc.run(['$rootScope', function ($rootScope) {
    ...
    $rootScope.plugin("adminTasks", "Admin Tasks", "page", {
        menu: "tools",
...
arc.directive("adminTasks", function () {
    return {
        restrict: "EA",
        replace: true,
        scope: {
        ...
        templateUrl: "__/plugins/admin-tasks/template.html",
        ...
        controller: ["$scope", "$rootScope", "$http", "$tm1", "$translate", "$timeout", function ($scope, $rootScope, $http, $tm1, $translate, $timeout) {
            ...
            $scope.$on("close-tab", function (event, args) {
                ...
                if (args.page == "adminTasks" && args.instance == $scope.instance && args.name == null) {
