...
arc.run(['$rootScope', function ($rootScope) {
    ...
    $rootScope.plugin("bauMonthly", "BAU Monthly", "page", {
        menu: "tools",
        icon: "fa-briefcase",
...
arc.directive("bauMonthly", function () {
    return {
        ...
        templateUrl: "__/plugins/bau-monthly/template.html",
        ...
        controller: ["$scope", "$rootScope", "$http", "$tm1", "$translate", "$timeout", function ($scope, $rootScope, $http, $tm1, $translate, $timeout) {
            ...
            $scope.calculatePercentage = function () {
               ...
               var nbStepsOpen = 0 ;
               var nbStepsTotal = 0 ;
               for(var step in $scope.steps.monthly){
                    nbStepsTotal ++;
                    if($scope.steps.monthly[step].open == false){
                        nbStepsOpen ++;
                    }
               } 
               $scope.stepPercentage = parseInt(nbStepsOpen / nbStepsTotal * 100);
            };
